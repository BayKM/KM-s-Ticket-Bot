...
message.delete()
return message.channel.send(`Bu komutu bir bilet kanalında kullanın.`).then(c => c.delete({timeout: 10000})) } }
...
message.delete()
return message.channel.send(`Bir bilet kanalı değil.`).then(c => c.delete({timeout: 10000})) }
